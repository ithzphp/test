...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/index.php/Back/News/add.html" enctype="multipart/form-data">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="url1" name="news_img" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="" />
      ...
      <div class="form-group"> 
          ...
          <div class="field" style="padding-top:8px;"> 
            不推荐 <input name='type' id="ishome"  type="radio" value='0'/>
            推荐 <input name='type' id="isvouch"  type="radio" value='1'/>
          </div>
        </div>
      <div class="form-group">
        <div class="label">
